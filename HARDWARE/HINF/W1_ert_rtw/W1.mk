###########################################################################
## Makefile generated for Simulink model 'W1'. 
## 
## Makefile     : W1.mk
## Generated on : Fri Dec 16 10:35:26 2016
## MATLAB Coder version: 2.7 (R2014b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\W1.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = W1_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = W1_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\W1.exe
...
INCLUDES_BUILDINFO = $(START_DIR)\W1_ert_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=W1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\W1_ert_rtw\W1.c $(START_DIR)\W1_ert_rtw\W1_data.c

MAIN_SRC = $(START_DIR)\W1_ert_rtw\ert_main.c
...
{$(START_DIR)\W1_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\W1_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
